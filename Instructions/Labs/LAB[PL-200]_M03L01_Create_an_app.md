...
10. Select **Data** from the left bar. Click **Add data**. From the list of entities, select **Accounts.** 

10. Add a header to your app by selecting the **+** button (the Insert button) on the left tab and selecting **Text label.** Use the pane on the right side of the screen to enter **Fabrikam Accounts** in the **Text** field and hit **Enter**. You can edit the size, font, and other attributes to customize the look and feel of the application.
...
10. Click the **X** in the top right corner to close the preview screen
