...
In this practice lab, you will create a Power Pages portal and expose milestone data to customers.

## Exercise 1 – Sign up for Power Pages

In this exercise, you will create and explore a Power Pages site and the Power Pages tools. You will make minor changes to the site content.
...
1. Use the Environment selector to switch to the **Practice** environment.

1. Click **Get Started**.

1. If you are asked about your experience creating websites, click **Skip**.

1. Select the **Default design template**.
...
1. The portal site will deploy. It can take around an hour for your site to fully deploy.

    ![Power Pages portal deployed.](../media/portal-deployed.png)

### Task 1.2 - Review the Power Pages site
...
### Task 1.3 - Sign in to the Power Pages site
...
### Task 1.4 - Review the Portal Management model-driven app
...
### Task 1.5 - Edit the site footer in Portal Management
...
### Task 1.6 - Review Portal Designer
...
### Task 1.7 - Update pages in the Portal Designer
...
### Task 1.8 - View the changes to the site
