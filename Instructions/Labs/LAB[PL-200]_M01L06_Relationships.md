...
In this exercise, you will create calculated and rollup columns.

We will create columns based on the relationships between the Project table and other tables. The calculated column will add the email address for the approver to the outcome table. The rollup column will sum the funding values of projects.
